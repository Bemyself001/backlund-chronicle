...
export const LATEST_UPDATE = {
  ...
  changes: [
    "为怀表主线及高窗之下、雷管、铁门支线登记九位重要人物；只在明确的任务节点、物品或线索出现后收录。",
    "人物档案展示已知身份、与你的交集、最近进展、最后已知地点与获知记录，并可跳转关联任务。",
    "白鸢尾的代号与真名共用档案，未取得对应证据时隐藏真名和非凡身份；获知红夫人或阿兹克不等于已经见面。",
    "旧存档依据已确认事实与阶段历史补齐档案；保存已获知的经历，保留原关系数值和其他已有关系。",
    "导出完成后展示文件名和保存位置。Android 10 及以上保存到内部存储 Download/贝克兰德纪事，较旧 Android 使用系统保存窗口。",
    "网页版支持另存为或浏览器下载，并提示查找位置；取消、写入失败与仅发起下载分别显示，不再提前宣称导出成功。",
    "Android 文件导出需要安装本版 APK；旧 APK 即使已热更新到同版页面，也会提示覆盖安装以启用文件保存功能。",
  ],
};

const RELEASE_1611_UPDATE = {
  date: "2026-09-26", dateLabel: "2026.09.26",
...
const RELEASE_169_UPDATE = {
  ...
  changes: [
    "到达雾鸦旅店后可一键睡觉8小时；自由休息每满2小时恢复1点生命与理智，单次最多各4点。",
    "教堂祷告恢复2点理智与2点灵性，保留1回合消耗和所有教堂共享的5回合冷却。",
    "所有角色可购买外伤药膏、安神药剂和恢复药剂，分别恢复2点生命、1点理智和1点灵性；药师仍可购买材料自行制作。",
    "购买或自制药剂均可在行囊或特殊行动中使用，每次扣除一份；属性已满不消耗，恢复不超过上限，旧存档中的自制药剂也可使用。",
    "发布1.6.9，沿用原Android包名、正式签名及APK与热更新发布流程。",
  ],
};

const RELEASE_165_UPDATE = {
