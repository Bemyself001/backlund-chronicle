...
export const LATEST_UPDATE = {
  ...
  changes: [
    "修复开局调查怀表后任务栏没有对应任务的问题：选择调查怀表或首次检查后即显示「家传怀表：失踪的舅舅」，保留原有检查与解读条件，并沿用任务去重机制。",
    "修复检查完怀表并生成线索剧情后仍显示开局选项的问题：同步替换为前往公共图书馆、前往商会街钟表行和暂时搁置三项选择，普通、快速与演示模式一致，显示选项不会自动移动或推进任务。",
