...
export const JournalPanel = memo(function JournalPanel({ game }) {
  ...
  return <div className={styles.content}>
    ...
    {tab === "quests" && <section><h3>案件任务 <small>{tasks.length}</small></h3>{tasks.map(task => {
