  ...
  return (
    <main className={styles.page} id="main">
      ...
      <header className={styles.masthead}>
        <div className={styles.brandMark} aria-hidden="true"><span>MC</span></div>
        <p>灰檐港私人调查档案 · 1349</p>
      ...
      <section className={styles.hero} aria-labelledby="welcome-title">
        <div className={styles.registry}><span>案卷编号</span><strong>GH—1107</strong></div>
        <p className={styles.kicker}>AI NARRATIVE SANDBOX</p>
        <h1 id="welcome-title"><span>雾中</span>纪事</h1>
      ...
      <aside className={styles.caseNote} aria-label="开局介绍"><span>01</span><p>灰檐港连续第九日落雨。<br />今夜，停摆七年的钟将再次报时。</p></aside>
