...
export const TALENTS = [
  ...
  { id: "heirloom-watch", name: "家传怀表", description: "一件来自家人的旧怀表，开局随身携带；仔细检查也许能发现什么。", effects: { item: { itemId: "heirloom-watch", name: "家传怀表", category: "工具", description: "黄铜表壳磨得发亮，走时大致准确，边缘留着多年使用形成的细痕。", weight: 0.1, rarity: "少见", tags: ["可检查"], hiddenInfo: "机芯夹层里藏着一小卷纸条，上面用陌生的速记符号写着一句话，墨迹尚未完全褪色。" } } },
];
